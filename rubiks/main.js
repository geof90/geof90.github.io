...
function init() {
    ...
    document.getElementById("solve").onclick = function() { solve(cubes, scene); };
    document.getElementById("rotate").onclick = function() { tweener = rotate(cubes, scene) || tweener; };
}
...
function rotate(cubes, scene) {
    if (locked) return;
    locked = true;
    
    var axis = getAxis("F", true);
